...
class SurveyOverviewTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return FlatButton(
      ...
      onPressed: () => openSurveyDetailsPage(context, survey, colorMap[survey.id % colorMap.length]),
      child: Container(
        ...
        child: Padding(
          ...
          child: Row(
            ...
            children: <Widget>[
              Expanded(
                flex: 2,
                child: Center(child: SurveyOverviewIcon(id: survey.id, backgroundColor: colorMap[survey.id % colorMap.length], indicateLocal: survey.isLocal,)),
              ),
              Expanded(
                flex: 5,
